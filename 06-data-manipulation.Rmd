...
```{r loadEdSurvey6, echo=FALSE, message=FALSE, warning=FALSE}
library(EdSurvey)
library(dplyr)
library(ggplot2)
...
```{r loadtidyEdSurvey, message=FALSE, warning=FALSE}
...
```{r withtidyEdSurvey, message=FALSE, warning=FALSE}
...
```{r tidyEdSurvey1, warning=FALSE, message=FALSE}
...
```{r tidyEdSurvey2, warning=FALSE, message=FALSE}
sdf2 <- sdf %>% 	
...
```{r tidyEdSurvey3, warning=FALSE, message=FALSE}
sdf2 %>% 
  group_by(prof) %>%
  summarize(mrpcm1)
```
...
```{r tidyEdSurvey4, warning=FALSE, message=FALSE}
sdf2 %>% 	
