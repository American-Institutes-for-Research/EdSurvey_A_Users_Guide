...
```{r coverImage, echo=FALSE, fig.align='center', fig.cap="NCES 2021-044", out.width="70%"}
## to render epub, out.width needs to be a number value
## ```{r coverImage, echo=FALSE, fig.align='center', fig.cap="NCES 2021-044", out.width=500}
...
```{r IESwname_color, echo=FALSE,out.width="50%"}
## to render epub, out.width needs to be a number value
##```{r IESwname_color, echo=FALSE, fig.align='center', fig.cap="NCES 2021-044", out.width=200}
knitr::include_graphics('images/IESwname_color.png')
```
